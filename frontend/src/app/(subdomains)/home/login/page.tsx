      ...
      <div className="z-10 w-full max-w-md relative border border-secondary/20 bg-card/30 backdrop-blur-md p-8 rounded-2xl flex flex-col gap-6 shadow-[0_0_30px_rgba(0,150,255,0.08)]">
        ...
        <div className="flex flex-col items-center text-center gap-2 mb-2">
          ...
          <h1 className="text-2xl font-bold font-mono tracking-widest text-foreground">
            SECURE<span className="text-secondary">_GATEWAY</span>
          </h1>
        ...
        <form onSubmit={handleEmailLogin} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5 font-mono text-xs">
            <div className="flex justify-between items-center">
              <label className="text-muted-foreground font-bold tracking-wider uppercase">Credentials Password</label>
              <span className="text-secondary text-[10px] hover:underline cursor-pointer">Recover Key?</span>
            </div>
            <input
              type="password"
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2.5 border border-secondary/30 text-xs font-mono font-bold tracking-wider text-secondary rounded-lg bg-secondary/5 hover:bg-secondary/15 transition-all duration-300 active:scale-98"
        >
          CONNECT_WITH_GITHUB
        </button>
        ...
        <div className="text-center font-mono text-[10px] text-muted-foreground mt-2">
          New Operative?{' '}
          <a href="/register" className="text-secondary hover:underline font-bold">
